...
class Controlador:
    ...
    def MostrarDatosPeli(self, id):
        ...
        title_label = tk.Label(details_window, font="bold 10", bg="medium purple", text="Título: " + pelicula_detalle["title"])
        title_label.pack(pady=10)


        overview_text = tk.Text(details_window, font="bold 10", bg="medium purple", width=40, height=10)
        ...
        language_label = tk.Label(details_window, font="bold 10", bg="medium purple", text="Lenguaje original: " + pelicula_detalle["original_language"])
        language_label.pack(pady=10, padx=10)

        release_date_label = tk.Label(details_window, font="bold 10", bg="medium purple", text="Fecha de lanzamiento: " + pelicula_detalle["release_date"])
        release_date_label.pack(pady=10, padx=10)

        genres_label = tk.Label(details_window, font="bold 10", bg="medium purple", text="Géneros: " + ", ".join([genre["name"] for genre in pelicula_detalle["genres"]]))
